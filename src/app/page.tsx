      ...
      <section id="about" className="about-section relative min-h-screen flex flex-col justify-center px-6 md:px-16 py-28 border-t overflow-hidden transition-colors duration-300 scroll-mt-[52px]" style={{ background: c.bg, borderColor: c.border }} aria-label="About Garv Malik">
        ...
        <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-14 md:gap-20 items-center">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="font-mono text-sm leading-relaxed" style={{ color: c.textMuted }}>I like taking something that feels complicated and making it feel obvious in hindsight. Most of my projects start the same way — talking to people, watching where they actually get stuck, before a single screen gets designed. I've built a mood-based city discovery app, a relocation guide for international students, a sports meetup platform, and most recently a voice AI that helps patients say the things they're too embarrassed to tell their doctor. Different problems, same instinct: figure out what's actually in someone's way, then get out of it.</p>
